...
bot = TeleBot(token='6452588311:AAEADCoXamKxclVW9QwJevUBSe-suoG3NhA', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Давай сгенерируем номер тестовой банковской карты\nВыбери ее тип:', # текст сообщения
